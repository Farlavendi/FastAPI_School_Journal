...
def create_access_token(
    ...
    return create_token(
        ...
        token_ttl=settings.jwt.access_token_ttl,
    )
...
def create_refresh_token(
    ...
    return create_token(
        token_type="refresh",
        token_data=jwt_payload,
        token_ttl=settings.jwt.refresh_token_ttl,
    )
...
async def issue_tokens(
    ...
    response.set_cookie(
        ...
        secure=True,
        samesite="strict",
        max_age=settings.jwt.access_token_ttl,
    )
    response.set_cookie(
        key="refresh_token",
        value=refresh_token,
        ...
        secure=True,
        samesite="strict",
        max_age=settings.jwt.refresh_token_ttl,
    )
